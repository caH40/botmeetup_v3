...
3.3.19 +папка документации добавлена в индекс git;  
3.3.20 +устранен баг с линком на канал объявлений из приветствия бота;   
3.3.21 +исправлено формирование url запроса координат для погоды;  
